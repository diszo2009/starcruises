...
class MagenThemes_Customer_AddressController extends Mage_Customer_AddressController
{
    /**
    ...
    public function formPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
			...
			$this->_getSession()->getCustomer()->setMobilenumber($this->getRequest()->getParam('mobilenumber'));
			$this->_getSession()->getCustomer()->setNationality($this->getRequest()->getParam('nationality'));
			//$this->_getSession()->addError($this->getRequest()->getParam('mobilenumber'));
            $errors = array();
            ...
            try {
            	$this->_getSession()->getCustomer()->save();
